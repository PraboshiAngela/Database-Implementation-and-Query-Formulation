...
--
-- Host: 127.0.0.1    Database: assignment_02
-- ------------------------------------------------------
...
CREATE TABLE `enrollment` (
  ...
  `EnrGrade` decimal(3,1) DEFAULT NULL,
...
CREATE TABLE `faculty` (
  ...
  `FacDept` varchar(5) DEFAULT NULL,
  `FacRank` varchar(10) DEFAULT NULL,
  `FacSalary` int DEFAULT NULL,
  `FacSupervisor` int DEFAULT NULL,
  `FacHireDate` date DEFAULT NULL,
  `FacZipCode` int DEFAULT NULL,
  PRIMARY KEY (`FacSSN`),
  KEY `fk1_idx` (`FacSupervisor`),
  CONSTRAINT `fk1` FOREIGN KEY (`FacSupervisor`) REFERENCES `faculty` (`FacSSN`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `registration` (
  `RegNo` int NOT NULL,
  `RegStatus` char(2) DEFAULT NULL,
  `RegDate` date DEFAULT NULL,
  `RegTerm` varchar(10) DEFAULT NULL,
...
CREATE TABLE `student` (
  ...
  `StdMajor` varchar(5) DEFAULT NULL,
  `StdClass` varchar(5) DEFAULT NULL,
  `StdGPA` decimal(3,1) DEFAULT NULL,
...
-- Dump completed on 2021-05-14 20:56:26
